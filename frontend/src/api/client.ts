...
export const api = {
  ...
  pauseEvidenceIndexing: (evidenceId: string, payload: { reason?: string } = {}) => request<{ accepted: boolean; evidence_id: string; status: string; previous_status?: string; previous_phase?: string; stopped_live_job?: boolean; lock_released?: boolean; retry_allowed?: boolean }>(`/evidences/${evidenceId}/indexing/pause`, { method: "POST", body: JSON.stringify(payload) }),
