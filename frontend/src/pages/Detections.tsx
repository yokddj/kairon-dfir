    ...
    <div className="space-y-6">
      <section className="rounded-[28px] border border-line bg-panel/70 p-6 shadow-panel">
        ...
        <p className="mt-2 text-sm text-muted">
          Detections are automatic matches generated by built-in heuristics, Sigma/heuristic rules over indexed events, or YARA rules over preserved files.{" "}
          <Link to="/rules" className="text-accent underline underline-offset-4">Manage rules</Link> to add coverage beyond the built-in heuristics.
        </p>
