...
import { api, type Evidence, type MemoryUploadReadiness } from "../api/client";
    ...
    <div className="space-y-6">
      <section className="rounded-[28px] border border-line bg-panel/70 p-6 shadow-panel">
        ...
        <div className="mt-2 flex flex-wrap items-start justify-between gap-4">
          ...
          <Link to={`/cases/${caseId}/memory`} className="rounded-xl border border-line bg-abyss/70 px-3 py-2 text-xs text-muted">Open Memory Analysis</Link>
        </div>
      </section>
