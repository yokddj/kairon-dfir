...
- Ingests Windows and Linux forensic evidence into case-centered investigations through a guided, plain-language wizard that classifies evidence and previews the exact processing pipeline before anything runs. See [docs/unified-evidence-ingestion.md](docs/unified-evidence-ingestion.md) and [docs/preflight-inspection.md](docs/preflight-inspection.md).
...
- [Unified evidence ingestion](docs/unified-evidence-ingestion.md)
- [Preflight inspection](docs/preflight-inspection.md)
