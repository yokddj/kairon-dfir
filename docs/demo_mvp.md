# Kairon DFIR MVP Demo Guide

## Purpose

This demo shows the end-to-end analyst workflow in Kairon DFIR using a fully synthetic dataset:
...
- `Artifact Views` as a case workspace view, not an evidence upload area
