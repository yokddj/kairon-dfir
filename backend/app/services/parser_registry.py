...
_REGISTRY: dict[str, dict[str, Any]] = {
    ...
    "linux_systemd": {
        ...
        "source_patterns": ["*/etc/systemd/system/*.service", "*/lib/systemd/system/*.service"],
        "enabled_for_usable_search": True,
        "searchable": True,
        "maturity": "experimental",
        "output_contract_version": SEARCHABLE_CONTRACT_VERSION,
    ...
    "linux_packages": {
        ...
        "supported_extensions": [".log"],
        "source_patterns": ["*/var/log/dpkg.log*", "*/var/log/yum.log*", "*/var/log/dnf.log*", "*/var/log/apt/history.log*"],
        "enabled_for_usable_search": True,
        "searchable": True,
        "maturity": "partial",
        "output_contract_version": SEARCHABLE_CONTRACT_VERSION,
    ...
    "linux_os_info": {
        ...
        "source_patterns": ["*/etc/os-release", "*/etc/hostname"],
        "enabled_for_usable_search": True,
        "searchable": True,
        "maturity": "experimental",
        "output_contract_version": SEARCHABLE_CONTRACT_VERSION,
