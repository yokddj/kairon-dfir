...
def finding_to_dict(item: Finding) -> dict[str, Any]:
    return {
        ...
        "linked_artifact_family": getattr(item, "linked_artifact_family", None),
        "linked_artifact_type": getattr(item, "linked_artifact_type", None),
        "linked_event_id": getattr(item, "linked_event_id", None),
        "source_view": getattr(item, "source_view", None),
        "source_route": getattr(item, "source_route", None),
        "source_timestamp": getattr(item, "source_timestamp", None).isoformat() if getattr(item, "source_timestamp", None) else None,
        "source_label": getattr(item, "source_label", None),
        "source_summary": getattr(item, "source_summary", None),
        "source_snapshot_json": getattr(item, "source_snapshot_json", None),
