...
DOCS_CATALOG = [
    ...
    {"slug": "unified-evidence-ingestion", "title": "Unified evidence ingestion", "summary": "Wizard guiado de 7 pasos (con Server Health Check) para añadir evidencia sin conocer el pipeline interno, con una sola subida de red.", "filename": "unified-evidence-ingestion.md"},
